...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    hr_by_team_year_sf_la = pandas.read_csv(hr_by_team_year_sf_la_csv)

    gg = ggplot(hr_by_team_year_sf_la, aes('yearID', 'HR', color='teamID')) +\
     geom_point() + geom_line() + ggtitle('Total HRs by year') + xlab('Year') + ylab('HR')
